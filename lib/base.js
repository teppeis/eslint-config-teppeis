...
module.exports = {
  ...
  "rules": {
    ...
    "no-undef-init": 2,
    // This is prevented by `no-global-assign` and `no-shadow-restricted-names`.
    "no-undefined": 0,
    ...
    // see https://github.com/mysticatea/eslint-plugin-eslint-comments/issues/9
    "eslint-comments/disable-enable-pair": 0,
    // This rule is replaced with `--report-unused-disable-directives` CLI option
    // @see https://github.com/mysticatea/eslint-plugin-eslint-comments/issues/12
